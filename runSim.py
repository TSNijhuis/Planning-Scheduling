...
def simulate_over_time(self,total_hours=168, disruption_rates=(0.05, 0.05, 0.05)):
    ...
    stdev = float(self.stddev_entry.get())
...
class SimulationGUI:
    ...
    def setup_ui(self):
        ...
        tk.Label(input_frame, text="Order Stddev:").pack(side=tk.LEFT)
        self.stddev_entry = tk.Entry(input_frame, width=5)
        self.stddev_entry.insert(0, "40.0")
        self.stddev_entry.pack(side=tk.LEFT, padx=2)
